...
from sky.skylet.providers.vsphere.vsphere_utils import get_vsphere_credentials, \
...
class Vsphere(clouds.Cloud):
    ...
    def regions(cls) -> List[clouds.Region]:
        return service_catalog.regions(clouds=_CLOUD_VSPHERE)
    ...
    def get_default_instance_type(cls,
                                  ...
                                  disk_tier: Optional[str] = None) -> Optional[
        str]:
    ...
    def check_credentials(cls) -> Tuple[bool, Optional[str]]:
        ...
        try:
            for vcenter in get_vsphere_credentials():
                ...
                vs_client = vsphere_utils.VsphereClient(vcenter['name'],
                                                        vcenter['username'],
                                                        vcenter['password'],
                                                        vcenter['clusters'],
                                                        vcenter[skip_key])
