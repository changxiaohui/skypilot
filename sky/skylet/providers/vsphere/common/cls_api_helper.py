...
from sky.skylet.providers.vsphere.common.vim_utils import get_obj_by_moId
...
from sky.skylet.providers.vsphere.common.id_generator import generate_random_uuid
...
class ClsApiHelper(object):
    ...
    def deploy_ovf_template(self, vm_name, lib_item_id, ovf_summary, deployment_target, storage_profile_id):
        ...
        if result.succeeded:
            ...
            self.vm_obj = get_obj_by_moId(self.client.service_manager.content,
